...
class AppController extends Action {
	...
	public function timeline() {
		...
		$total_paginas = ceil($total_tweets['total']/$total_registros_paginas);
	...
	public function removerTweet(){
		...
		// Trabalho para o usuário remover
		$tweet_id = isset($_POST['tweet_id']) ? $_POST['tweet_id'] : '';
		
		$tweet = Container::getModel('Usuario');
		$tweet->__set('id_usuario', $_SESSION['id']);
		$tweet->removerTweetUsuario($tweet_id);
		header('Location: /timeline?');
	}
